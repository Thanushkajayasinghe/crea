            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand sticky_logo" href="<?php echo e(url('')); ?>"><img src="images/logo.png"
                                                                                    class="logo"
                                                                                    alt=""></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav" data-in="fadeIn" data-out="fadeOut">
                            <li>
                                <a href="<?php echo e(url('/')); ?>" class="dropdown-toggle" data-toggle="dropdown">Home </a>
                            </li>
                            <li class="dropdown">
...
<?php /**PATH C:\wamp64\www\crea\resources\views/property_details.blade.php ENDPATH**/ ?>