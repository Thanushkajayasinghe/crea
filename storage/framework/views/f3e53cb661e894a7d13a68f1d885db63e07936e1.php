...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/reality-icon.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/bootsnav.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/jquery.fancybox.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/cubeportfolio.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/settings.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/range-Slider.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/search.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('plugins/select2/css/select2.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('plugins/sweetalert/sweetalert.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/style.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('fonts/flaticon/flaticon.css')); ?>">
    <style>
        .select2-container {
            width: 100% !important;
        }
        ...
        #whyChooseUs {
            ...
            rgba(17, 20, 35, .3)), url("<?php echo e(asset('images/haddyliving.jpg')); ?>") no-repeat center / cover;
            overflow: hidden;
            position: relative;
        }
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo e(url('')); ?>" style="padding: 0;"><img src="images/logo.png"
                                                                                            class="logo" alt=""></a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Copyright © <?php echo e(date('Y')); ?> <span>CREA</span>. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\crea\resources\views/index.blade.php ENDPATH**/ ?>